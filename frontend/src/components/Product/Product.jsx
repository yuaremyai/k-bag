            ...
            <div className={`content ${theme}`}>
                ...
                <div className="image-container">
                    ...
                    <form className={`product-info ${theme}`}>
                        ...
                        <p className="product-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla magnam tempora similique beatae, maiores officiis excepturi eligendi iusto fugiat eveniet, suscipit cupiditate quaerat voluptates dignissimos repudiandae accusantium. Deserunt, cum doloremque.</p>
                        <div className="price">
                            <label>100$</label>
